 ...
 *
 */
public class LDownloader {
	final static  JFrame m_frm = new JFrame("Lyrics Downloader");
	...
	public static void main(String[] args) {
		...
		JButton btnSelectPlayerLocation = new JButton("Player Location");
		...
		DownloadTask task = new DownloadTask(_lrcCount, _model_songList, _list_songList,_txt_playerLocation);
		...
		_lrcCount.setBounds(156, 81, 254, 15);
