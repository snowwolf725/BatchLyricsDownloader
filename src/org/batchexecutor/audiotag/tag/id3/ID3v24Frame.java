...
import org.batchexecutor.audiotag.FileConstants;
import org.batchexecutor.audiotag.audio.generic.Utils;
import org.batchexecutor.audiotag.audio.mp3.MP3File;
import org.batchexecutor.audiotag.tag.EmptyFrameException;
import org.batchexecutor.audiotag.tag.InvalidFrameException;
import org.batchexecutor.audiotag.tag.InvalidFrameIdentifierException;
import org.batchexecutor.audiotag.tag.InvalidTagException;
import org.batchexecutor.audiotag.tag.TagOptionSingleton;
import org.batchexecutor.audiotag.tag.datatype.Lyrics3Line;
import org.batchexecutor.audiotag.tag.id3.framebody.AbstractID3v2FrameBody;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyCOMM;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyDeprecated;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodySYLT;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyTALB;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyTCOM;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyTIT2;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyTPE1;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyUSLT;
import org.batchexecutor.audiotag.tag.id3.framebody.FrameBodyUnsupported;
import org.batchexecutor.audiotag.tag.id3.framebody.ID3v24FrameBody;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyAUT;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyEAL;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyEAR;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyETT;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyINF;
import org.batchexecutor.audiotag.tag.lyrics3.FieldFrameBodyLYR;
import org.batchexecutor.audiotag.tag.lyrics3.Lyrics3v2Field;
