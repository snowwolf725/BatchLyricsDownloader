 ...
 *  @author : Eric Farng
 *
 *  Version @version:$Id: AbstractTagDisplayFormatter.java,v 1.3 2007/08/15 12:39:57 paultaylor Exp $
 *
 ...
 */
package org.batchexecutor.audiotag.logging;
...
public abstract class AbstractTagDisplayFormatter
{
    ...
    private static HashMap hexBinaryMap = new HashMap();
    ...
    public static String displayAsBinary(byte buffer)
    {
        ...
        return (String) hexBinaryMap.get(char1) + (String) hexBinaryMap.get(char2);
    }
